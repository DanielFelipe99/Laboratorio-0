...
public void generarInformeDiscos()throws FileNotFoundException{
    	...
    	for (int i=0; i<discos.size(); i++) {
    		Disco info = (Disco)discos.get(i);
    			pluma.println(
    				"Nombre: " + info.darArtista()+ "\n" +
    				"Genero: " + info.darGenero()+	"\n" +
    				"Precio: " + info.darPrecioDisco()
    					);
 		}
    ...
    public void informePrecios()throws FileNotFoundException{
    	...
    	for (int i=0; i<discos.size(); i++) {
    		...
    		Disco infoDisco = (Disco)discos.get(i);
    	
    		if(infoDisco.darGenero().equals("Pop") || infoDisco.equals("Rock")&&infoDisco.darPrecioDisco()<1000){
    			pluma.println(
    				"Nombre: " + infoDisco.darArtista()+
    				"Genero: " + infoDisco.darGenero()+
    				"Precio: " + infoDisco.darPrecioDisco()
    					);
 
    		throw new FileNotFoundException("No hay discos con estas condiciones");
    ...
    public String metodo1( )
    {
    	try {
			...
			return "Reporte generado existosamente";
		} catch (Exception e) {
